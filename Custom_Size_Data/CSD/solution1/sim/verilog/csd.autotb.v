...
`define AUTOTB_DUT      csd
`define AUTOTB_DUT_INST AESL_inst_csd
`define AUTOTB_TOP      apatb_csd_top
`define AUTOTB_LAT_RESULT_FILE "csd.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "csd.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_csd_top
...
`define AUTOTB_TVIN_A_V_out_wrapc  "../tv/rtldatafile/rtl.csd.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V_out_wrapc  "../tv/rtldatafile/rtl.csd.autotvin_B_V.dat"
`define AUTOTB_TVIN_op_out_wrapc  "../tv/rtldatafile/rtl.csd.autotvin_op.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.csd.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.csd.autotvout_ap_return.dat"
module `AUTOTB_TOP;
