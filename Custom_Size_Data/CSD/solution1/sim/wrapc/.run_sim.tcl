...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "csd.autotvin.dat"
	set constFileTvOut       "csd.autotvout.dat"
	set constFileHdlTvIn     "csd.autohdltvin.dat"
	set constFileHdlTvOut    "csd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
