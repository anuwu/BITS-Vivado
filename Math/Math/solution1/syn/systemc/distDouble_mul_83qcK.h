...
// ==============================================================
#ifndef __distDouble_mul_83qcK__HH__
#define __distDouble_mul_83qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_mul_83qcK) {
    ...
    SC_CTOR(distDouble_mul_83qcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
