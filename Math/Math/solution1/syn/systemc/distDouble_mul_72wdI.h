...
// ==============================================================
#ifndef __distDouble_mul_72wdI__HH__
#define __distDouble_mul_72wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_mul_72wdI) {
    ...
    SC_CTOR(distDouble_mul_72wdI):  ACMP_mul_us_U ("ACMP_mul_us_U") {
