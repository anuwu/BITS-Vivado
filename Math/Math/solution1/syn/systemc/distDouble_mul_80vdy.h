...
// ==============================================================
#ifndef __distDouble_mul_80vdy__HH__
#define __distDouble_mul_80vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_mul_80vdy) {
    ...
    SC_CTOR(distDouble_mul_80vdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
