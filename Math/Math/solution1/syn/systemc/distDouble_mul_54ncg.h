...
// ==============================================================
#ifndef __distDouble_mul_54ncg__HH__
#define __distDouble_mul_54ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_mul_54ncg) {
    ...
    SC_CTOR(distDouble_mul_54ncg):  ACMP_mul_su_U ("ACMP_mul_su_U") {
