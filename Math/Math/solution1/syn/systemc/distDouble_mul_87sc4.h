...
// ==============================================================
#ifndef __distDouble_mul_87sc4__HH__
#define __distDouble_mul_87sc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_mul_87sc4) {
    ...
    SC_CTOR(distDouble_mul_87sc4):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
