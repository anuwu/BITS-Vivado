...
// ==============================================================
#ifndef __distDouble_mac_muxdS__HH__
#define __distDouble_mac_muxdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_mac_muxdS) {
    ...
    SC_CTOR(distDouble_mac_muxdS):  simcore_mac_0_U ("simcore_mac_0_U") {
