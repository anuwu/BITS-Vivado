...
// ==============================================================
#ifndef __distDouble_dadddsyd2__HH__
#define __distDouble_dadddsyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distDouble_dadddsyd2) {
    ...
    SC_CTOR(distDouble_dadddsyd2):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
