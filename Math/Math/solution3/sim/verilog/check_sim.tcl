...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.distFix.autotvin_x1_V.dat"
         "c.distFix.autotvin_y1_V.dat"
         "c.distFix.autotvin_x2_V.dat"
         "c.distFix.autotvin_y2_V.dat"
         "c.distFix.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.distFix.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
