...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "distFix.autotvin.dat"
	set constFileTvOut       "distFix.autotvout.dat"
	set constFileHdlTvIn     "distFix.autohdltvin.dat"
	set constFileHdlTvOut    "distFix.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
