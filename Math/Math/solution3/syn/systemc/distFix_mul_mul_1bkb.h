...
// ==============================================================
#ifndef __distFix_mul_mul_1bkb__HH__
#define __distFix_mul_mul_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFix_mul_mul_1bkb) {
    ...
    SC_CTOR(distFix_mul_mul_1bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
