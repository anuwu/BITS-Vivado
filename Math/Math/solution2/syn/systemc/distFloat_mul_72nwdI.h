...
// ==============================================================
#ifndef __distFloat_mul_72nwdI__HH__
#define __distFloat_mul_72nwdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_72nwdI) {
    ...
    SC_CTOR(distFloat_mul_72nwdI):  ACMP_mul_us_U ("ACMP_mul_us_U") {
