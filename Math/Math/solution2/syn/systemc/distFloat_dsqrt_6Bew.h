...
// ==============================================================
#ifndef __distFloat_dsqrt_6Bew__HH__
#define __distFloat_dsqrt_6Bew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_dsqrt_6Bew) {
    ...
    SC_CTOR(distFloat_dsqrt_6Bew):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
