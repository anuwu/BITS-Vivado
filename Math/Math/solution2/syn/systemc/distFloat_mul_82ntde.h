...
// ==============================================================
#ifndef __distFloat_mul_82ntde__HH__
#define __distFloat_mul_82ntde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_82ntde) {
    ...
    SC_CTOR(distFloat_mul_82ntde):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
