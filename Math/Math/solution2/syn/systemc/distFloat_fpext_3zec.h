...
// ==============================================================
#ifndef __distFloat_fpext_3zec__HH__
#define __distFloat_fpext_3zec__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_fpext_3zec) {
    ...
    SC_CTOR(distFloat_fpext_3zec):  ACMP_fpext_U ("ACMP_fpext_U") {
