...
// ==============================================================
#ifndef __distFloat_mul_83nqcK__HH__
#define __distFloat_mul_83nqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_83nqcK) {
    ...
    SC_CTOR(distFloat_mul_83nqcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
