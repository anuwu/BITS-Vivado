...
// ==============================================================
#ifndef __distFloat_mul_92nrcU__HH__
#define __distFloat_mul_92nrcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_92nrcU) {
    ...
    SC_CTOR(distFloat_mul_92nrcU):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
