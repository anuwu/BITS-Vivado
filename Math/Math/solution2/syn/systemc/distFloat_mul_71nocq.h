...
// ==============================================================
#ifndef __distFloat_mul_71nocq__HH__
#define __distFloat_mul_71nocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_71nocq) {
    ...
    SC_CTOR(distFloat_mul_71nocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
