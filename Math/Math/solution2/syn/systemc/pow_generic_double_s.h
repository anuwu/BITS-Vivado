...
#include "distFloat_mul_54sncg.h"
#include "distFloat_mul_71nocq.h"
#include "distFloat_mul_73npcA.h"
#include "distFloat_mul_83nqcK.h"
#include "distFloat_mul_92nrcU.h"
#include "distFloat_mul_87nsc4.h"
#include "distFloat_mul_82ntde.h"
#include "distFloat_mul_77nudo.h"
#include "distFloat_mul_80nvdy.h"
#include "distFloat_mul_72nwdI.h"
#include "distFloat_mac_mulxdS.h"
...
struct pow_generic_double_s : public sc_module {
    ...
    distFloat_mul_54sncg<1,2,54,6,54>* distFloat_mul_54sncg_U1;
    distFloat_mul_71nocq<1,2,71,4,75>* distFloat_mul_71nocq_U2;
    distFloat_mul_73npcA<1,2,73,6,79>* distFloat_mul_73npcA_U3;
    distFloat_mul_83nqcK<1,2,83,6,89>* distFloat_mul_83nqcK_U4;
    distFloat_mul_92nrcU<1,2,92,6,98>* distFloat_mul_92nrcU_U5;
    distFloat_mul_87nsc4<1,2,87,6,93>* distFloat_mul_87nsc4_U6;
    distFloat_mul_82ntde<1,2,82,6,88>* distFloat_mul_82ntde_U7;
    distFloat_mul_77nudo<1,2,77,6,83>* distFloat_mul_77nudo_U8;
    distFloat_mul_80nvdy<1,2,80,12,90>* distFloat_mul_80nvdy_U9;
    distFloat_mul_72nwdI<1,2,72,13,83>* distFloat_mul_72nwdI_U10;
    distFloat_mac_mulxdS<1,1,16,16,19,31>* distFloat_mac_mulxdS_U11;
