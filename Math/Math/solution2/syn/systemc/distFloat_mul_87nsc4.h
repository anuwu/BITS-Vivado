...
// ==============================================================
#ifndef __distFloat_mul_87nsc4__HH__
#define __distFloat_mul_87nsc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_87nsc4) {
    ...
    SC_CTOR(distFloat_mul_87nsc4):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
