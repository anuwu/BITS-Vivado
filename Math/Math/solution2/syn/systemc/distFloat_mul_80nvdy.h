...
// ==============================================================
#ifndef __distFloat_mul_80nvdy__HH__
#define __distFloat_mul_80nvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_80nvdy) {
    ...
    SC_CTOR(distFloat_mul_80nvdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
