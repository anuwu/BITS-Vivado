...
// ==============================================================
#ifndef __distFloat_mac_mulxdS__HH__
#define __distFloat_mac_mulxdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mac_mulxdS) {
    ...
    SC_CTOR(distFloat_mac_mulxdS):  simcore_mac_0_U ("simcore_mac_0_U") {
