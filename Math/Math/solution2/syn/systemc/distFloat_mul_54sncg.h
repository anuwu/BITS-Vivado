...
// ==============================================================
#ifndef __distFloat_mul_54sncg__HH__
#define __distFloat_mul_54sncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distFloat_mul_54sncg) {
    ...
    SC_CTOR(distFloat_mul_54sncg):  ACMP_mul_su_U ("ACMP_mul_su_U") {
