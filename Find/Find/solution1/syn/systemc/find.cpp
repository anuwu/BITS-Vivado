...
const sc_lv<2> find::ap_ST_fsm_state1 = "1";
const sc_lv<2> find::ap_ST_fsm_state2 = "10";
...
find::find(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( icmp_ln6_fu_66_p2 );
    sensitive << ( idx_0_reg_55 );

    SC_METHOD(thread_icmp_ln8_fu_78_p2);
    sensitive << ( val_r );
    ...
    sc_trace(mVcdFile, idx_fu_72_p2, "idx_fu_72_p2");
    sc_trace(mVcdFile, ap_block_state2, "ap_block_state2");
    sc_trace(mVcdFile, idx_0_reg_55, "idx_0_reg_55");
    sc_trace(mVcdFile, icmp_ln8_fu_78_p2, "icmp_ln8_fu_78_p2");
...
void find::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         ...
         !((esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_vec_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_vec_full_n.read()))))) {
        idx_0_reg_55 = idx_fu_72_p2.read();
...
void find::thread_ap_block_state2() {
    ap_block_state2 = ((esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_vec_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_vec_full_n.read())));
}
...
void find::thread_ap_done() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_0, in_vec_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_vec_full_n.read()))) && 
         esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_1))) {
...
void find::thread_icmp_ln6_fu_66_p2() {
    icmp_ln6_fu_66_p2 = (!idx_0_reg_55.read().is_01() || !ap_const_lv4_A.is_01())? sc_lv<1>(): sc_lv<1>(idx_0_reg_55.read() == ap_const_lv4_A);
}

void find::thread_icmp_ln8_fu_78_p2() {
    icmp_ln8_fu_78_p2 = (!in_vec_dout.read().is_01() || !val_r.read().is_01())? sc_lv<1>(): sc_lv<1>(in_vec_dout.read() == val_r.read());
}

void find::thread_idx_fu_72_p2() {
    idx_fu_72_p2 = (!idx_0_reg_55.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(idx_0_reg_55.read()) + sc_biguint<4>(ap_const_lv4_1));
}
...
void find::thread_out_vec_din() {
    out_vec_din = esl_zext<8,1>(icmp_ln8_fu_78_p2.read());
}
...
void find::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && !((esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_vec_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_vec_full_n.read()))) && esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && !((esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_vec_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln6_fu_66_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_vec_full_n.read()))))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
