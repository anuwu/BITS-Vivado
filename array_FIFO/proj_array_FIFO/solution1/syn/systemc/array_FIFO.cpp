...
array_FIFO::array_FIFO(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_icmp_ln100_fu_63_p2);
    sensitive << ( d_o_full_n );
    sensitive << ( d_i_empty_n );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( icmp_ln100_fu_63_p2 );
    ...
    sc_trace(mVcdFile, icmp_ln100_fu_63_p2, "icmp_ln100_fu_63_p2");
...
void array_FIFO::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
         !((esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_i_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_o_full_n.read()))))) {
        i_0_reg_52 = i_fu_69_p2.read();
...
void array_FIFO::thread_ap_block_state2() {
    ap_block_state2 = ((esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_i_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_o_full_n.read())));
}
...
void array_FIFO::thread_ap_done() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_0, d_i_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_o_full_n.read()))) && 
         esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_1))) {
...
void array_FIFO::thread_i_fu_69_p2() {
    i_fu_69_p2 = (!i_0_reg_52.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_0_reg_52.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void array_FIFO::thread_icmp_ln100_fu_63_p2() {
    icmp_ln100_fu_63_p2 = (!i_0_reg_52.read().is_01() || !ap_const_lv3_4.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_52.read() == ap_const_lv3_4);
}
...
void array_FIFO::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && !((esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_i_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_o_full_n.read()))) && esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && !((esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_i_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln100_fu_63_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, d_o_full_n.read()))))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
