...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("idx_address1", 2, hls_out, 2, "ap_memory", "MemPortADDR2", 1),
	Port_Property("idx_ce1", 1, hls_out, 2, "ap_memory", "MemPortCE2", 1),
	Port_Property("idx_we1", 1, hls_out, 2, "ap_memory", "MemPortWE2", 1),
	Port_Property("idx_d1", 32, hls_out, 2, "ap_memory", "MemPortDIN2", 1),
	Port_Property("idx_q1", 32, hls_in, 2, "ap_memory", "MemPortDOUT2", 1),
};
