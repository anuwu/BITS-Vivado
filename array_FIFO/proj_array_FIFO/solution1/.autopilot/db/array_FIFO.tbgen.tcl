...
set Spec2ImplPortList { 
	...
	idx { ap_memory {  { idx_address0 mem_address 1 2 }  { idx_ce0 mem_ce 1 1 }  { idx_we0 mem_we 1 1 }  { idx_d0 mem_din 1 32 }  { idx_q0 mem_dout 0 32 }  { idx_address1 MemPortADDR2 1 2 }  { idx_ce1 MemPortCE2 1 1 }  { idx_we1 MemPortWE2 1 1 }  { idx_d1 MemPortDIN2 1 32 }  { idx_q1 MemPortDOUT2 0 32 } } }
}
