...
// ==============================================================
#ifndef __FFT_mac_mulsub_9sdEe__HH__
#define __FFT_mac_mulsub_9sdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_mac_mulsub_9sdEe) {
    ...
    SC_CTOR(FFT_mac_mulsub_9sdEe):  simcore_mac_0_U ("simcore_mac_0_U") {
