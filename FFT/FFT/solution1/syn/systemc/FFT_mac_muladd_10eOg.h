...
// ==============================================================
#ifndef __FFT_mac_muladd_10eOg__HH__
#define __FFT_mac_muladd_10eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_mac_muladd_10eOg) {
    ...
    SC_CTOR(FFT_mac_muladd_10eOg):  simcore_mac_1_U ("simcore_mac_1_U") {
