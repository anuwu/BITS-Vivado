...
// ==============================================================
#ifndef __FFT_mul_mul_16s_9cud__HH__
#define __FFT_mul_mul_16s_9cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_mul_mul_16s_9cud) {
    ...
    SC_CTOR(FFT_mul_mul_16s_9cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
