...
// ==============================================================
#ifndef __FFT_mul_mul_10s_1bkb__HH__
#define __FFT_mul_mul_10s_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_mul_mul_10s_1bkb) {
    ...
    SC_CTOR(FFT_mul_mul_10s_1bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
